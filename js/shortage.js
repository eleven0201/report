    ...
    series: [
        {
            ...
            barWidth: 20,  // 柱形的宽度
            barCategoryGap: '20%',  // 柱形的间距
            data: [150, 230, 500, 450, 600]
        }
    ]
};
// 基于准备好的dom，初始化echarts实例
var myResult1 = echarts.init(document.getElementById('shortage'));
// 使用刚指定的配置项和数据显示图表。
myResult1.setOption(option);
    ...
    series: [
        {
            ...
            barWidth: 20,  // 柱形的宽度
            barCategoryGap: '20%',  // 柱形的间距
            data: [600, 400, 700, 900, 1100]
        }
    ]
};
// 基于准备好的dom，初始化echarts实例
var myResult = echarts.init(document.getElementById('result1'));
// 使用刚指定的配置项和数据显示图表。
myResult.setOption(option);
    ...
    series: [
        {
            ...
            barWidth: 20,  // 柱形的宽度
            barCategoryGap: '20%',  // 柱形的间距
            data: [240, 500, 600, 800, 900]
        }
    ]
};
// 基于准备好的dom，初始化echarts实例
var myResult1 = echarts.init(document.getElementById('shortage1'));
// 使用刚指定的配置项和数据显示图表。
myResult1.setOption(option);